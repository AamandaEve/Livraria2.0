...
public class Livraria implements Library{
    ...
    public void inicio() {
        ...
        switch (acao) {
            ...
            case 3:
                ...
                usuario = new Usuario(nome, dataDeNascimento);      
                Usuario usuario2 = new Usuario(nome, dataDeNascimento, idUsuario); 
            ...
            case 8:
                ...
                nome = sc.nextLine();
                System.out.println("Qual a id do usuário?");
                id = sc.nextInt();
                usuario = new Usuario(nome, id);
                for(Usuario usuarioTeste3 : listaDeUsuariosCadastrados){
                    if(usuario.getNome().equals(usuarioTeste3.getNome()) && usuario.getId()==usuarioTeste3.getId()){
    ...
    public void removerLivro(Livro livro) {
        //if(listaDeLivrosCadastrados.size()<= 0){
    ...
    public void emprestarLivro(Usuario usuario, Livro livro) {
        for(Usuario user : listaDeUsuariosCadastrados){
            if(user.getNome().equals(usuario.getNome()) && user.getId()==usuario.getId()){
                ...
                System.out.println("Usuário não encontrado :(" + usuario.getId());
            }
        }
    }
